...
<nav
  ...
  tabindex="-1"
  class="relative z-1 w-0 immich-scrollbar overflow-x-hidden overflow-y-auto bg-light/80 pt-8 transition-all duration-200 dark:bg-immich-dark-bg/80 sidebar:w-64"
