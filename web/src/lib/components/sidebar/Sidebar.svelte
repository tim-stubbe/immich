...
<nav
  ...
  tabindex="-1"
  class="relative z-1 w-0 immich-scrollbar overflow-x-hidden overflow-y-auto bg-light/65 pt-8 backdrop-blur-xl transition-all duration-200 dark:bg-immich-dark-bg/65 sidebar:w-64"
